...
import { forgotPassword, forgotPasswordOtpVerification, resendResetPasswordOtp, resendVerificationEmail, resetPassword, sendOtp, verifyEmail } from '../controllers/auth.controller.js';
